                    ...
                    {Object.keys(data.historyData).map((key, index) => {
                        ...
                        return (
                            <TabPanel key={index} backgroundColor={'white'}>
                                <Steps orientation="vertical" activeStep={1} size="sm">
                                        ...
                                        <Step
                                            ...
                                            label={
                                                <Flex alignItems={'center'} gap={8}>
                                                    ...
                                                    <Flex flexDir={'column'} alignItems={'flex-start'}>
                                                        <Text fontWeight={'bold'}>Action By</Text>
                                                        <Text>{step.action_by}</Text>
                                                    </Flex>
                                                    <Flex flexDir={'column'} alignItems={'flex-start'}>
                                                        <Text fontWeight={'bold'}>Details</Text>
                                                        <Text>Reason: {step.reason}</Text>
                                                    </Flex>
                                                    <Flex flexDir={'column'} alignItems={'flex-start'}>
                                                        <Text fontWeight={'bold'}>Source</Text>
                                                        <Text>{step.source}</Text>
                                                    </Flex>
                                                </Flex>
                                            }
                                        ></Step>
